...
train_dataset=Dataset.from_csv('./story_train.csv')
validation_dataset=Dataset.from_csv('./story_validation.csv')
num_choices=2
...
model = FlaxGPTNeoForMultipleChoice.from_pretrained('EleutherAI/gpt-neo-125M',input_shape=(1,num_choices,1))

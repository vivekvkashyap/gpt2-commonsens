...
def preprocess(example):
    example['first_sentence']=[example['ctx_a']]*num_choices
    example['second_sentence']=[example['ctx_b']+' '+example['endings'][i] for i in range(num_choices)]
    return example
...
len_train_dataset=39905
len_validation_dataset=10042
len_test_dataset=10003
